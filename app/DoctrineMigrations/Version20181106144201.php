 ...
 */
class Version20181106144201 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD nature_id INT DEFAULT NULL, ADD fonction_id INT DEFAULT NULL, ADD assurances VARCHAR(255) DEFAULT NULL, DROP nature, DROP fonction');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD nature VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD fonction VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, DROP nature_id, DROP fonction_id, DROP assurances');
